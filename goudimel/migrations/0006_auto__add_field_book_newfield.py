...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.newfield'
        db.add_column(u'goudimel_book', 'newfield',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.newfield'
        db.delete_column(u'goudimel_book', 'newfield')
    ...
    models = {
        'goudimel.book': {
            ...
            'newfield': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
