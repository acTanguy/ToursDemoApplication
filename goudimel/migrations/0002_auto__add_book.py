...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'goudimel_book', (
            ...
            ('publisehd', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('remarks', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
