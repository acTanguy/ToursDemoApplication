...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Book.rism'
        db.delete_column(u'goudimel_book', 'rism')

        # Adding field 'Book.rism_id'
        db.add_column(u'goudimel_book', 'rism_id',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Book.rism'
        db.add_column(u'goudimel_book', 'rism',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Book.rism_id'
        db.delete_column(u'goudimel_book', 'rism_id')
    ...
    models = {
        'goudimel.book': {
            ...
            'publisehd': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
